...
open class PopupButton: UIButton {

    public typealias PopupButtonAction = () -> Void
    ...
    open fileprivate(set) var buttonAction: PopupButtonAction?
    ...
    /*!
     ...
     - returns: PopupButton
     */
    @objc public init(title: String, height: Int = 45, dismissOnTap: Bool = true, action: PopupButtonAction?) {
